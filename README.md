...
optional arguments:
  ...
  --phase_list_pred PHASE_LIST_PRED [PHASE_LIST_PRED ...]
                        Phases to compute times and tstar for (default: PP, PPP,
                        SS, SSS, ScS, SKS)
  --plot                Plot convergence in T-X plot
  --absolute_times      Return absolute travel times (default: False, ie return
                        time relative to first phase in phase_list_dist)
```
